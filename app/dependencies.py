"""
Dependency injection container — FastAPI Depends() callables.

All singletons are instantiated once and shared across requests.
"""
...
# ╭─────────────────────────────────────────────────────────╮
# │  Singletons (cached so they are created only once)      │
# ╰─────────────────────────────────────────────────────────╯
