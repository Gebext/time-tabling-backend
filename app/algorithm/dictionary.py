"""
Data Dictionary — loads and exposes all reference data required by the algorithm.

Refactored from the original production/dictionary/dictionary.py.
Now encapsulated in a class for testability and dependency injection.
"""
...
class DataDictionary:
    """
    Central data holder for the timetabling algorithm.

    All data is loaded once from CSV and exposed via clean properties/methods.
    The repository layer handles CRUD; this class serves the algorithm.
    """
    ...
    def reload(self) -> None:
        """Reload all data (e.g. after CRUD updates)."""
        self._load_all()
    ...
    def relasi_guru_mapel(self) -> pd.DataFrame:
        """Return relasi_guru_mapel dataframe for evaluator."""
        return self.relasi_df

    @property
    def mapel_jam_per_minggu(self) -> dict[int, int]:
        """Alias for jam_per_minggu_mapel."""
